...
class siswaController extends Controller
{
    ...
    public function import_excel(Request $request)
	{
		...
		return redirect()->route('sisw.index')->with('success','Data Berhasil di Import');
	}
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('sisw.index')->with('success','Data Berhasil di Input');
    }
    ...
    public function update(Request $request, Siswa $sisw)
    {
        ...
        return redirect()->route('sisw.index')->with('success','Siswa Berhasil di Update');
    }
    ...
    {
        $sisw->delete();
        return redirect()->route('sisw.index')->with('success','Data Berhasil di Hapus');
    }
